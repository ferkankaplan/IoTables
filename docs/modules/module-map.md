...
App-flow documents in [docs/app-flows](../app-flows/README.md) define cross-app behavior, happy paths, branches, and acceptance criteria. Module, schema, and API decisions must implement those flows instead of inventing independent product semantics.
