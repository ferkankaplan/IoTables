...
| `tenant_registry.update_profile` | PlatformApp, TenantApp | tenantId, editable profile fields | TenantApp limited to own tenant; name/subdomain/lifecycle immutable to tenant | Single tenant row update; GSM changes require audit | Updated tenant profile |
