"""extend audit catalog for menu catalog

Revision ID: 20260703_0012
Revises: 20260703_0011
Create Date: 2026-07-03 13:00:00.000000+00:00

Rollback note:
- Safe to downgrade only before menu catalog audit events are written.
  After use, downgrading requires retaining or remapping `menu_catalog.changed`
  and `availability.changed` events before restoring the previous constraint.
"""
...
down_revision: str | Sequence[str] | None = "20260703_0011"
